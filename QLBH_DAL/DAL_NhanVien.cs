...
namespace QLBH_DAL
{
    public class DAL_NhanVien
    {
        ...
        {
            db.ExecuteNonQuery("insert into nhanvien values('NV' + cast (next value for  MANV_TU_TANG as varchar(5)),N'" + sp.Hoten + "','" + sp.Sodt + "','" + sp.Ngaysinh + "',N'" + sp.Diachi + "',N'" + sp.Phai+ "', N'"+sp.Tinhtrang+"',"+sp.Luong+")");
        }
